...
void print_help(char *argv[])
{
    ...
    printf("  -c, --auto-cr               Prepend \\r when only \\n is seen\n");
...
void parse_options(int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        c = getopt_long(argc, argv, "b:d:f:s:p:o:cnetl:m:vh", long_options, &option_index);
        ...
        switch (c)
        {
            ...
            case 'c':
                option.auto_carriage_return = true;
                break;
